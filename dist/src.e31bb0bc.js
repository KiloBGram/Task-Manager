...
},{"underscore":"../node_modules/underscore/underscore.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var Task = _backbone.default.Model.extend({
...
var TaskView = _backbone.default.View.extend({
  className: 'task',
  model: new Task(),
  template: _underscore.default.template((0, _jquery.default)('#template').html()),
  events: {
  ...
  render: function render() {
    ...
    var textContainer = this.$el.find('.task_text-container');
  ...
  editTask: function editTask(event) {
    ...
    this.$('.task_text-container').html("<input type=\"text\" class=\"task_text-edit-input\"\n       value=\"".concat(this.$('.task_text-container').html().trim(), "\"/>"));
    var length = this.$('.task_text-edit-input').val().length;
  ...
  saveChanges: function saveChanges(event) {
    if ((0, _jquery.default)('.task_text-edit-input').val().trim() !== '') {
      this.$('.task_save-button').hide();
      this.$('.task_edit-button').show();
      this.model.set({
        title: (0, _jquery.default)('.task_text-edit-input').val()
      });
      this.$('.task_text-container').html((0, _jquery.default)('.task_text-edit-input').val());
    } else {
      alert('You must give your task some text');
    }
  },
  saveIfEnter: function saveIfEnter(e) {
    if (e.key === 'Enter') {
      this.saveChanges();
    }
  },
  checkboxChecked: function checkboxChecked(event) {
  ...
  moveup: function moveup() {
    var index = tasks.models.indexOf(this.model);
...
var TaskList = _backbone.default.Collection.extend({
...
var GlobalView = _backbone.default.View.extend({
  model: tasks,
  initialize: function initialize() {
  ...
  saveToStorage: function saveToStorage() {
    ...
    window.localStorage.setItem('todo', JSON.stringify(arr.map(function (i) {
      return i.toJSON();
    })));
  },
  render: function render() {
    ...
    arr.forEach(function (task) {
      _this.$('.global-grid_main-content').append(new TaskView({
        model: task
      }).render().$el);
    });
  },
  addTask: function addTask() {
    var input = (0, _jquery.default)('.manager_new-task-text');
  ...
  pressedKey: function pressedKey(e) {
    if (e.key === 'Enter') {
      this.addTask();
    }
  }
...
(0, _jquery.default)(document).ready(function () {
  ...
  var storage = window.localStorage.getItem('todo');
...
},{"backbone":"../node_modules/backbone/backbone.js","underscore":"../node_modules/underscore/underscore.js","jquery":"../node_modules/jquery/dist/jquery.js","./styles/main.scss":"styles/main.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
